...
<body style="background-image: url('<?php echo base_url('Assets/img/register.jpg')  ?>'); background-size: cover;">
    ...
    <div class="col-sm-6 col-md-4">
      ...
      <div class="card border-info text-center">
        ...
        <div class="card-body">
          ...
          <form class="form-signin" method="post" action="<?php echo base_url();?>register_con/validation" >

					
						<input placeholder="UseName" type="text" name="user_name" class="form-control mb-2" value="<?php echo set_value('user_name'); ?>">
						...
						<input type="submit" name="Register" value="Register" class="btn btn-lg btn-info btn-block mb-1">
